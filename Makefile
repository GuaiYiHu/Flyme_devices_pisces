...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer KeyChain NfcNci PicoTts PrintSpooler Stk UserDictionaryProvider BackupRestoreConfirmation DefaultContainerService ExternalStorageProvider FusedLocation InputDevices ProxyHandler SharedStorageBackup Shell NvCPLSvc telresources CMSettingsProvider CMAudioService ThemesProvider Tag UnifiedNlp Extra Brevent SmartcardService IchnaeaNlpBackend LocalGsmNlpBackend AppleWifiNlpBackend LocalWifiNlpBackend QuickBoot
